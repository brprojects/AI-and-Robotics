...
class Node:
    ...
    # compares the h_score value
    def __lt__(self, other):
        return self.h_score < other.h_score

    def heuristic_cost(self, other):
        # Euclidean distance
        return HEURISTIC_CONST * ((self.x - other.x) ** 2 + (self.y - other.y) ** 2) ** 0.5
...
def astar(start_node, end_node):
    ...
    start_node.h_score = start_node.heuristic_cost(end_node)
    ...
    while len(open_list)>0:
        ...
        for neighbour in current_node.neighbours:
            ...
            if tentative_g_score < neighbour.g_score:
                ...
                neighbour.h_score = neighbour.g_score + neighbour.heuristic_cost(end_node)
...
def main():
    ...
    plt.show()
    # plt.savefig('../images/A_star2.png')
